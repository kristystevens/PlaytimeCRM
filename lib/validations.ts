...
export const playerSchema = z.object({
  ...
  skillLevel: z.enum(['WHALE', 'PRO', 'NIT', 'AMATEUR', 'PUNTER', 'RECREATIONAL', 'INTERMEDIATE', 'ADVANCED', 'PROFESSIONAL']).optional(),
  tiltRisk: z.boolean().optional(),
  preferredGames: z.array(z.string()).optional(),
  preferredPlaytimes: z.array(z.string()).optional(),
  preferredStakes: z.array(z.string()).optional(),
  notes: z.string().optional().nullable(),
  assignedCommunityManager: z.enum(['MIA', 'KRISTY']).optional().nullable(),
